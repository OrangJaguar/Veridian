...
export default function DataDashboardPage() {
  ...
  const { data: stats, isLoading: statsLoading } = useAdminSummaryStats();
  const { data: signupTrend = [] } = useAdminSignupTrend();
      ...
      <section className="admin-dashboard-section" aria-label="Live stats">
        ...
        {statsLoading ? (
          ...
          <div className="admin-stats-grid">
            ...
            <StatCard label="Avg mastery" value={stats?.averageMastery != null ? `${stats.averageMastery}%` : '—'} />
