...
// Expose SDK internals only in local development — never in production builds.
if (typeof window !== 'undefined' && import.meta.env.DEV) {
  ...
  try {
    const sections = {
      ...
      connectors: base44.connectors,
    };
    for (const [section, obj] of Object.entries(sections)) {
      if (!obj) continue;
      const methods = Object.getOwnPropertyNames(Object.getPrototypeOf(obj) || obj)
