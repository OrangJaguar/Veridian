...
- keyTerms: 3–5 { term, definition } — critical terms/formulas/rules from THIS section only.
- takeaways: 2–4 short strings — what to remember after reading (exam-relevant).
...
export function buildLearningGuideUserPrompt({
  ...
  return JSON.stringify({
    ...
    layoutNotes: {
      ...
      keyTermsCount: '3-5 per section',
      takeawaysCount: '2-4 per section',
