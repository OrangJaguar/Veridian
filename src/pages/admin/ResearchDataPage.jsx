...
export default function ResearchDataPage() {
  const { data: health, isPending: healthPending } = useResearchDataHealth();
  const { data: pairs = [], isPending: pairsPending } = useQualifyingPairs();
  const { data: flags = [], isPending: flagsPending } = useDataQualityFlags();
  ...
  return (
    <div className="admin-journeys-page research-data-page">
      <header className="admin-page-header">
        <h1 className="admin-page-title">Research Data</h1>
        <p className="admin-page-subtitle">Data health, qualifying cohorts, and anonymized exports</p>
      </header>
      ...
      <section className="research-section">
        <h2 className="research-section-title">Exports</h2>
